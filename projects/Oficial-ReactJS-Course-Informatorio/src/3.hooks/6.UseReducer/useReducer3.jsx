...
const useCharactersData = (url = 'https://rickandmortyapi.com/api/character') => {
    ...
    const fetchCharacters = (url) => {
        return fetch(url)
            ...
            .then((data) => {
                ...
                // Este es nuestro interval con el distpach de datos y success !!
                ...
                // Este otro de aqui abajo es el dispatch simple sin intervalos de tiempo
                // dispatch({ type: ACTIONS.SUCCESS, payload: { infoD: data.info, charC: data.results}})
            })
            .catch((err) => {
    ...
    console.log(state.characters, 1)
